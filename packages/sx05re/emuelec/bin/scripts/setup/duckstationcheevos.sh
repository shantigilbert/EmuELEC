...
# Copyright (C) 2022-present Héctor Calvarro (https://github.com/kelvfimer)

# Script for adding retroachievements in Duckstation on Emuelec

# Usage :
# Precondition => retroachievements setup must be added on Emulationstation before running the script.
...
#Variables for checking if [Cheevos] or enabled true or fase are presented.
